...
_____|_____|_____
  ...
  7  |  8  |  9  
    ...
    if j == "O":
        adv = 'X'
        print('Então eu fico com o X.')
    elif j == 'X':
        adv = 'O'
        print('\nEntão eu fico com o O.')

    print('\nQuem joga primeiro?', end=' ')

    while primeiro != 'EU' and primeiro != "PC":
        instr = 'Digite EU e pressione Enter para você começar, ou digite PC e pressione Enter para começar:'
    ...
    def atualizar_jogadas_j2():
        ...
        print('Deixe-me pensar minha jogada...')
        sleep(1.5)
        ...
        while jogada_aleatoria == 1 and pos1 == 'ocupada' or \
            ...
            jogada_aleatoria == 7 and pos7 == 'ocuapda' or \
            jogada_aleatoria == 8 and pos8 == 'ocupada' or \
                jogada_aleatoria == 9 and pos9 == 'ocupada':
            jogada_aleatoria = randint(1,9)

        print('Eu jogo na posição {}!'.format(jogada_aleatoria))
